	...
	items:{
		Scene1:{
			...
			items:{
				...
				Msg1:{type:"message", name:"Speak", external:true, url:"@giftProtocol@://localhost:8090/tutor/cs/cs.exe?template=Library%2FTemplates%2FServer%2FSpeech.xml&character=TashaHead&addons=&voice=Microsoft%20Zira%20Desktop&size=250,200&autoactionlevel=2&customhair=tashahair&customtop=shirt1&flashversion=9&actionscript=3", method:"get", addvariables:"Text", character:"Char1"},
				Msg2:{
