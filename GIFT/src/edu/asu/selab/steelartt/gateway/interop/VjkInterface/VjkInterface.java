package mil.arl.gift.gateway.interop.VjkInterface;
 ...
 *
 */
public class VjkInterface extends AbstractInteropInterface {

    /** The logger for the class */
    private static final Logger logger = LoggerFactory.getLogger(VjkInterface.class);
     ...
     *        be null.
     */
    public VjkInterface(String displayName) {
    ...
    public void setEnabled(boolean value) throws ConfigurationException {
        ...
        if (value) {
            if (logger.isInfoEnabled()) {
                logger.info("Enabling Unity interface - VJK");
            }
            ...
            if (logger.isInfoEnabled()) {
                logger.info("Disabling Unity interface VJKKKK");
            }
