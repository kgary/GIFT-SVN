 ...
 * one of two possible engagement states.
 * 
 * @author mhoffman
 *
 */
public class EngagementTwoStatePredictor extends AbstractTwoStatePredictor {
	 ...
	 */
	public EngagementTwoStatePredictor(AbstractClassifier classifier){
	    super(DEFAULT_STATE_ATTRIBUTE, DEFAULT_LOW_VALUE, DEFAULT_HIGH_VALUE, DEFAULT_UNKNOWN_VALUE, classifier);
	}
	...
	public String toString(){
	    ...
	    sb.append("[EngagementTwoStatePredictor:");
