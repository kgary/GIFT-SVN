...
/**
 * Action for unlocking a SensorsConfiguration.
 * 
 * @author elafave
 */
public class UnlockSensorsConfiguration implements Action<GatServiceResult> {

	/**
	 * Path of the sensors configuration being unlocked.
	 */
     ...
     */
    public UnlockSensorsConfiguration() {
    }
    ...
    public String toString(){
        ...
        sb.append("[UnlockSensorsConfiguration: ");
