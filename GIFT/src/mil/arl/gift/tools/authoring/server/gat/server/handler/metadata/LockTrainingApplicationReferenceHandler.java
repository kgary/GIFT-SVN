...
/**
 * Handles request to lock a trainingApplicationReference so other users can't edit it.
 */
public class LockTrainingApplicationReferenceHandler implements ActionHandler<LockTrainingApplicationReference, LockFileResult> {

    /**  instance of the logger. */
    private static Logger logger = LoggerFactory.getLogger(LockTrainingApplicationReferenceHandler.class);
    
	/* (non-Javadoc)
	 * @see net.customware.gwt.dispatch.server.ActionHandler#execute(net.customware.gwt.dispatch.shared.Action, net.customware.gwt.dispatch.server.ExecutionContext)
	 */
	@Override
	public LockFileResult execute(LockTrainingApplicationReference action, ExecutionContext context)
	    ...
	    MetricsSenderSingleton.getInstance().endTrackingRpc("metadata.LockTrainingApplicationReference", start);
        return result;
	}
	 ...
	 */
	@Override
	public Class<LockTrainingApplicationReference> getActionType() {
		return LockTrainingApplicationReference.class;
	}
	 ...
	 */
	@Override
	public void rollback(LockTrainingApplicationReference lockTrainingApplicationReference, LockFileResult result,
