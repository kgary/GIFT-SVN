...
/**
 * Action for locking a sensors configuration.
 * 
 * @author elafave
 */
public class LockSensorsConfiguration implements Action<LockFileResult> {

	/**
	 * Path of the sensors configuration being locked.
	 */
     ...
     */
    public LockSensorsConfiguration() {
    }
    ...
    public String toString(){
        ...
        sb.append("[LockSensorsConfiguration: ");
