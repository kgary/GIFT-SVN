...
public class RichTextToolbar extends Composite {
	...
	/** The Constant logger. */
	private static final Logger logger = Logger.getLogger(RichTextToolbar.class.getName());
	...
	/** The Style for the Rich Text Area tool bar button styles */
	private static final String RTA_BUTTON_STYLE = "gatRtaButton";
	...
	//The RichTextArea this Toolbar refers to and the Interfaces to access the RichTextArea
	/** The style text. */
	...
	public RichTextToolbar(RichTextArea richtext) {
		...
		//Some graphical stuff to the main panel and the initialization of the new widget
		outer.setWidth("100%");
    ...
    private ToggleButton createToggleButton(String url, Integer top, Integer left, Integer width, Integer height, String tip) {
        ...
        tb.addStyleName(RTA_BUTTON_STYLE);
        if (tip != null) {
            tb.setTitle(tip);
        }
        return tb;
