...
/**
 * The Class ArchiveSensorDataEditor.
 */
public class ArchiveSensorDataEditor extends Composite {
	
	/** The ui binder. */
    interface ArchiveSensorDataEditorUiBinder extends UiBinder<Widget, ArchiveSensorDataEditor> {} 
	private static ArchiveSensorDataEditorUiBinder uiBinder = GWT.create(ArchiveSensorDataEditorUiBinder.class);
    ...
    public ArchiveSensorDataEditor() {		
        initWidget(uiBinder.createAndBindUi(this));
		
		//If the user selects a new writer impl then that change needs to
    ...
    public void setTitlePrefix() {
    	caption.setText("Archive Sensor Data");
    }
