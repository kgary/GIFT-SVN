...
/**
 * The Class MarksmanshipPrecisionConditionEditor.
 */
public class MarksmanshipPrecisionConditionEditorImpl extends ConditionInputPanel<MarksmanshipPrecisionCondition> {

    /** The ui binder. */
    private static MarksmanshipPrecisionConditionEditorUiBinder uiBinder = GWT
            .create(MarksmanshipPrecisionConditionEditorUiBinder.class);
    ...
    /**
     * The Interface MarksmanshipPrecisionConditionEditorUiBinder.
     */
    interface MarksmanshipPrecisionConditionEditorUiBinder
            extends UiBinder<Widget, MarksmanshipPrecisionConditionEditorImpl> {
    }
     ...
     */
    public MarksmanshipPrecisionConditionEditorImpl() {
        initWidget(uiBinder.createAndBindUi(this));

        setupDirtyHandlers();
        setupHelpHandlers();

        /* If the user changes the MarksmanshipPrecisionCondition's expectedNumberOfShots */
        ...
        expectedNumberOfShotsTextBox.addMouseOverHandler(new MouseOverHandler() {
            ...
            public void onMouseOver(MouseOverEvent arg0) {
                SharedResources.getInstance().getEventBus().fireEvent(new FormFieldFocusEvent(
                        FormFieldEnum.MARKSMANSHIP_PRECISION_CONDITION_EXPECTED_NUMBER_OF_SHOTS));
            }
        });
