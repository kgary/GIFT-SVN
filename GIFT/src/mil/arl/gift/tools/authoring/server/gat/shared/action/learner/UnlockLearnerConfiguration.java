...
/**
 * Action for unlocking a LearnerConfiguration.
 * 
 * @author elafave
 */
public class UnlockLearnerConfiguration implements Action<GatServiceResult> {

	/**
	 * Path of the learner configuration being unlocked.
	 */
     ...
     */
    public UnlockLearnerConfiguration() {
    }
    ...
    public String toString(){
        ...
        sb.append("[UnlockLearnerConfiguration: ");
