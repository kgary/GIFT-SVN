...
/**
 * The condition input editor implementation for {@link SpotReportCondition}.
 */
public class SpotReportConditionInputEditorImpl extends ConditionInputPanel<SpotReportCondition> {

    /** The UiBinder that combines the ui.xml with this java class */
    private static SpotReportConditionInputEditorImplUiBinder uiBinder = GWT
            .create(SpotReportConditionInputEditorImplUiBinder.class);

    /** Defines the UiBinder that combines the ui.xml with a java class */
    interface SpotReportConditionInputEditorImplUiBinder extends UiBinder<Widget, SpotReportConditionInputEditorImpl> {
    }
    ...
    /**
     * Creates a new editor for modifying {@link SpotReportCondition}s
     */
    public SpotReportConditionInputEditorImpl() {
