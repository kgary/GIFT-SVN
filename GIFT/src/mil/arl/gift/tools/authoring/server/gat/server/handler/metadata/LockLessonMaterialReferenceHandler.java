...
/**
 * Handles request to lock a lessonMaterialReference so other users can't edit it.
 */
public class LockLessonMaterialReferenceHandler implements ActionHandler<LockLessonMaterialReference, LockFileResult> {

    /**  instance of the logger. */
    private static Logger logger = LoggerFactory.getLogger(LockLessonMaterialReferenceHandler.class);
    
	/* (non-Javadoc)
	 * @see net.customware.gwt.dispatch.server.ActionHandler#execute(net.customware.gwt.dispatch.shared.Action, net.customware.gwt.dispatch.server.ExecutionContext)
	 */
	@Override
	public LockFileResult execute(LockLessonMaterialReference action, ExecutionContext context)
	    ...
	    MetricsSenderSingleton.getInstance().endTrackingRpc("metadata.LockLessonMaterialReference", start);
        return result;
	}
	 ...
	 */
	@Override
	public Class<LockLessonMaterialReference> getActionType() {
		return LockLessonMaterialReference.class;
	}
	 ...
	 */
	@Override
	public void rollback(LockLessonMaterialReference lockLessonMaterialReference, LockFileResult result,
