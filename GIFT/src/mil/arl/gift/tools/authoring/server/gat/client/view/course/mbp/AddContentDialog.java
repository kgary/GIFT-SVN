...
/**
 * A dialog used to let users select content files to use in a Merrill's Branch Point and define their metadata attributes
 * 
 * @author nroberts
 */
public class AddContentDialog extends Composite {

	private static final Binder binder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, AddContentDialog> {
	}

	private static final Logger logger = Logger.getLogger(AddContentDialog.class.getName());
	...
	/**
	 * Update the content being authored based on the given concept's selection state, if necessary
	 * 
