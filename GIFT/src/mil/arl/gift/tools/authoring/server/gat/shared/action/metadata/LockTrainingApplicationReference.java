...
/**
 * Action for locking a trainingApplicationReference file.
 * 
 * @author nroberts
 */
public class LockTrainingApplicationReference implements Action<LockFileResult> {

	/**
	 * Path of the trainingApplicationReference being locked.
	 */
     ...
     */
    public LockTrainingApplicationReference() {
    }
    ...
    public String toString(){
        ...
        sb.append("[LockTrainingApplicationReference: ");
