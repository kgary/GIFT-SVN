...
/**
 * A place in which a Pedagogy Configuration can be edited.
 */
public class PedagogyConfigurationPlace extends GenericParamPlace{
     ...
     */
    public PedagogyConfigurationPlace(HashMap<String, String> startParams) {
        super(startParams);
    }
     ...
     * The Class Tokenizer.
     */
    public static class Tokenizer implements PlaceTokenizer<PedagogyConfigurationPlace> {

        /* (non-Javadoc)
         * @see com.google.gwt.place.shared.PlaceTokenizer#getToken(com.google.gwt.place.shared.Place)
         */
        @Override
        public String getToken(PedagogyConfigurationPlace place) {
         ...
         */
        @Override
        public PedagogyConfigurationPlace getPlace(String token) {

            return new PedagogyConfigurationPlace(PlaceParamParser.getParams(token)); 
        }
