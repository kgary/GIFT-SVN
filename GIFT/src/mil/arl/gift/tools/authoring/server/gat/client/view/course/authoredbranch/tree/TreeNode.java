...
/**
 * A JavaScriptObject that represents a node in a branch tree structure.
 * 
 * @author nroberts
 */
public class TreeNode extends Node {
	...
	public final native int id() /*-{
		return this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::ID_ATTRIBUTE] || -1;
	}-*/;
	...
	public final native int id(int id) /*-{
		return this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::ID_ATTRIBUTE] = id;
	}-*/;
	...
	public final native void setType(String type) /*-{
		this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::TYPE_ATTRIBUTE] = type;
	}-*/;
	...
	public final native String getType() /*-{
		return this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::TYPE_ATTRIBUTE];
	}-*/;
	...
	public final native void setLinks(Array<TreeLink> links)/*-{		
		this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::LINKS_ATTRIBUTE] = links;	
	}-*/;
	...
	public final native Array<TreeLink> getLinks()/*-{		
		return this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::LINKS_ATTRIBUTE];
	}-*/;
	...
	public final native void setWidth(double width) /*-{
		this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::WIDTH_ATTRIBUTE] = width;
	}-*/;
	...
	public final native double getWidth() /*-{
		return this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::WIDTH_ATTRIBUTE];
	}-*/;
	...
	public final native void setChildren(Array<TreeNode> children)/*-{		
		this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::CHILDREN_ATTRIBUTE] = children;	
	}-*/;
	...
	public final native Array<TreeNode> getChildren()/*-{		
		return this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::CHILDREN_ATTRIBUTE];
	}-*/;
	...
	public final native void x0(double x0) /*-{
		this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::X0_ATTRIBUTE] = x0;
	}-*/;
	...
	public final native double x0() /*-{
		return this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::X0_ATTRIBUTE];
	}-*/;
	...
	public final native void y0(double y0) /*-{
		this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::Y0_ATTRIBUTE] = y0;
	}-*/;
	...
	public final native double y0() /*-{
		return this[@mil.arl.gift.tools.authoring.server.gat.client.view.course.authoredbranch.tree.TreeNode::Y0_ATTRIBUTE];
	}-*/;
}