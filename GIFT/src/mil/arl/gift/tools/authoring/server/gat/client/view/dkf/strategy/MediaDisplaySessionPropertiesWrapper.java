...
/**
 * A widget used to edit domain session properties display settings for a piece of media 
 * 
 * @author nroberts
 */
public class MediaDisplaySessionPropertiesWrapper extends DisplaySessionPropertiesWrapper<Media.DisplaySessionProperties> {

    /**
     * Creates a new instance of this widget
     */
    public MediaDisplaySessionPropertiesWrapper() {
        super();
    }
