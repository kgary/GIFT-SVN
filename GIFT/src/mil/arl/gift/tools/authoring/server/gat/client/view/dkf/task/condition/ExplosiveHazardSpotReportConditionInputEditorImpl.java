...
/**
 * The condition input editor implementation for {@link ExplosiveHazardSpotReportCondition}.
 */
public class ExplosiveHazardSpotReportConditionInputEditorImpl extends ConditionInputPanel<ExplosiveHazardSpotReportCondition> {

    /** The UiBinder that combines the ui.xml with this java class */
    private static ExplosiveHazardSpotReportConditionInputEditorImplUiBinder uiBinder = GWT
            .create(ExplosiveHazardSpotReportConditionInputEditorImplUiBinder.class);

    /** Defines the UiBinder that combines the ui.xml with a java class */
    interface ExplosiveHazardSpotReportConditionInputEditorImplUiBinder extends UiBinder<Widget, ExplosiveHazardSpotReportConditionInputEditorImpl> {
    }
    ...
    /**
     * Creates a new editor for modifying {@link ExplosiveHazardSpotReportCondition}s
     */
    public ExplosiveHazardSpotReportConditionInputEditorImpl() {
