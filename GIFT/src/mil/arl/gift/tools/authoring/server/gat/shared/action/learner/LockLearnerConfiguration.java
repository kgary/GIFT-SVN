...
/**
 * Action for locking a learner configuration.
 * 
 * @author elafave
 */
public class LockLearnerConfiguration implements Action<LockFileResult> {

	/**
	 * Path of the learner configuration being locked.
	 */
     ...
     */
    public LockLearnerConfiguration() {
    }
    ...
    public String toString(){
        ...
        sb.append("[LockLearnerConfiguration: ");
