 ...
 *
 */
public class DashboardErrorWidget extends AbstractBsWidget {
	
	private static Logger logger = Logger.getLogger(DashboardErrorWidget.class.getName());

	private static DashboardErrorWidgetUiBinder uiBinder = GWT.create(DashboardErrorWidgetUiBinder.class);

	interface DashboardErrorWidgetUiBinder extends UiBinder<Widget, DashboardErrorWidget> {
	}
	 ...
	 */
	public DashboardErrorWidget(Object initParams, String backgroundImageFile) {
		
		logger.info("DashboardErrorWidget("+initParams+","+backgroundImageFile+") called.");
        ...
        mainContainer.getElement().getStyle().setBackgroundImage("url('"+backgroundImageFile+"')");
	...
	/**
	 * An error message for the error page
	 * 
	 * @author nroberts
	 */
