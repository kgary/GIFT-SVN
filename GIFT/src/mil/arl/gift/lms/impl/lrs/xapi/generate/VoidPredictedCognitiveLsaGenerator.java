...
/**
 * Generator for voiding xAPI Statements that target Predicted Cognitive Learner State Attribute xAPI Statements.
 * 
 * @author Yet Analytics
 *
 */
public class VoidPredictedCognitiveLsaGenerator extends VoidPredictedLearnerStateAttributeGenerator {
    /**
     ...
     */
    public VoidPredictedCognitiveLsaGenerator(AbstractKnowledgeSession knowledgeSession, String voiderSlug, String actorSlug, LearnerStateAttribute attribute,
        ...
        super(new PredictedCognitiveLsaGenerator(knowledgeSession, actorSlug, attribute, history, domainSessionId, domainId), domainSessionId, voiderSlug);
    }
}
