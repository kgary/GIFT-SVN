...
/**
 * xAPI Statement corresponding to the start of a Domain Session.
 * 
 * @author Yet Analytics
 *
 */
public class StartedDomainSessionStatement extends AbstractGiftStatement {

    public StartedDomainSessionStatement(Agent actor, DomainSessionActivity activity, DateTime timestamp) throws LmsXapiProfileException {
