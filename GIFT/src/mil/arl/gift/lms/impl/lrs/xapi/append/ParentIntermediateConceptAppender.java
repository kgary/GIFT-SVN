 ...
 *
 */
public class ParentIntermediateConceptAppender extends AbstractStatementAppender {
    /** name of the appender */
    private static final String appenderName = "Intermediate Concept Parent Appender";
    /** appender description */
    private static final String appenderInfo = "Creates Assessment xAPI Activity from Intermediate Concept Performance State and attaches to xAPI Statement as Parent Context Activity";
     ...
     */
    public ParentIntermediateConceptAppender(IntermediateConceptPerformanceState state) throws LmsXapiProfileException {
    ...
    public AbstractGiftStatement appendToStatement(AbstractGiftStatement statement) throws LmsXapiAppenderException {
        try {
            statement.addParentActivity(intermediateConceptATC.asActivity(intermediateConcept));
        } catch (LmsXapiActivityException e) {
            throw new LmsXapiAppenderException("Unable to append intermediate concept parent activity!", e);
        }
        return statement;
    }
}
