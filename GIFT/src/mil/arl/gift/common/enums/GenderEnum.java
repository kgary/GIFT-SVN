...
/**
 * Enumeration of the various Gender Types
 * 
 * @author mhoffman
 *
 */
public class GenderEnum extends AbstractEnum {

    private static final long serialVersionUID = 1L;
    
    private static List<GenderEnum> enumList = new ArrayList<GenderEnum>(2);
    private static int index = 0;

    public static final GenderEnum MALE = new GenderEnum("MALE", "Male");
    public static final GenderEnum FEMALE = new GenderEnum("FEMALE", "Female");
    
    private GenderEnum(String name, String displayName){
     ...
     */
    public static final List<GenderEnum> VALUES() {
