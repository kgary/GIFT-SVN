 ...
 * @author cragusa
 */
public class LowHighLevelEnum extends AbstractEnum {
    
    private static final long serialVersionUID = 1L;

    /** complete set of enumerations of this class */
    private static final List<LowHighLevelEnum> enumList = new ArrayList<LowHighLevelEnum>(4);
    
    /** set of enumerations that an author can pick from, a subset of the enumList */
    private static final List<LowHighLevelEnum> enumAuthorableList = new ArrayList<LowHighLevelEnum>(3);
    
    private static int index = 0;

    public static final LowHighLevelEnum UNKNOWN = new LowHighLevelEnum("Unknown", "Unknown", false);
    public static final LowHighLevelEnum LOW = new LowHighLevelEnum("Low", "Low");
    public static final LowHighLevelEnum HIGH = new LowHighLevelEnum("High", "High");
    
    private static final LowHighLevelEnum DEFAULT_VALUE = UNKNOWN;
     ...
     */
    private LowHighLevelEnum(String name, String displayName){
     ...
     */
    private LowHighLevelEnum(String name, String displayName, boolean authorable){
     ...
     *         name is not found.
     */
    public static LowHighLevelEnum valueOf(String name)
     ...
     *         value is not found.
     */
    public static LowHighLevelEnum valueOf(int value)
        throws EnumerationNotFoundException {
     ...
     */
    public static final List<LowHighLevelEnum> VALUES() {
