...
/**
 * This filter is used to find lesson material (lessonMaterial.xml) files.
 * 
 * @author jleonard
 */
public class LessonMaterialFileFilter implements FileFilter {
    
    /** The lesson material file extension */
    public static final String FILE_EXTENSION = "lessonMaterial.xml";
