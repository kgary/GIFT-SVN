...
public class UnfilteredSensorData extends AbstractSensorData {
    ...
    private Map<SensorAttributeNameEnum, Double> sensorAttributeToValue;
     ...
     */
    public UnfilteredSensorData(String sensorName, SensorTypeEnum sensorType, long elapsedTime, Map<SensorAttributeNameEnum, Double> sensorAttributeToValue){
     ...
     * 
     * @return Map<SensorAttributeNameEnum, Double>
     */
    public Map<SensorAttributeNameEnum, Double> getAttributeValues(){
