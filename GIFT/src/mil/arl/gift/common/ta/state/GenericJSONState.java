 ...
 * per state type
 */
public class GenericJSONState implements TrainingAppState {
    /**
     ...
     */
    public GenericJSONState(UUID uuid){
        setUUID(uuid);
    }
     ...
     */
    public static GenericJSONState fromEntityState(EntityState entityState){        
        GenericJSONState entityStateMessage = new EntityStateJSON(entityState);        
     ...
     */
    public static GenericJSONState fromDetonation(Detonation detonation){
        GenericJSONState detonationMessage = new DetonationJSON(detonation);       
     ...
     */
    public static GenericJSONState fromWeaponFire(WeaponFire weaponFire){
        GenericJSONState fireMessage = new WeaponFireJSON(weaponFire);        
        return fireMessage;
    }
     ...
     *
     */
    public static class CommonStateJSON extends GenericJSONState{
