...
/**
 * Represents a native seeked event (see
 * https://developer.mozilla.org/en-US/docs/Web/API/HTMLMediaElement/seeked_event).
 * 
 * @author sharrison
 */
public class VideoSeekedEvent extends DomEvent<VideoSeekHandler> {

    /** The type of the event to sink */
    private static final Type<VideoSeekHandler> TYPE = new Type<VideoSeekHandler>(ExtendedBrowserEvents.SEEKED,
            new VideoSeekedEvent());
