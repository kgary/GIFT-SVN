 ...
 *
 */
public class HiddenAnswerWeightsPropertySet extends AbstractPropertySet  {

    @SuppressWarnings("unused")
    private static Logger logger = Logger.getLogger(HiddenAnswerWeightsPropertySet.class.getName());


	/**
	 * Constructor (default)
	 */
	public HiddenAnswerWeightsPropertySet() {
	    super();
	    properties.setPropertyValue(SurveyPropertyKeyEnum.ANSWER_WEIGHTS, "");
