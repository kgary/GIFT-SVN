 ...
 *
 */
public class EmbeddedStopFreeze {
     ...
     * the Simulation Management.
     */
    public EmbeddedStopFreeze(long realWorldTime, Integer reason, Integer frozenBehavior, long requestID){
