...
public class EmbeddedSiman{
     ...
     */
    private EmbeddedSiman(SimanTypeEnum simanType) {
     ...
     */
    public static EmbeddedSiman Create(SimanTypeEnum simanType){
     ...
     * @return Siman the instance created
     */
    public static EmbeddedSiman CreatePause(){
        return new EmbeddedSiman(SimanTypeEnum.PAUSE);
    }
     ...
     * @return Siman the instance created
     */
    public static EmbeddedSiman CreateReset(){
        return new EmbeddedSiman(SimanTypeEnum.RESTART);
    }
     ...
     * @return Siman the instance created
     */
    public static EmbeddedSiman CreateResume(){
        return new EmbeddedSiman(SimanTypeEnum.RESUME);
    }
     ...
     * @return Siman the instance created
     */
    public static EmbeddedSiman CreateStart(){
        return new EmbeddedSiman(SimanTypeEnum.START);
    }
     ...
     * @return Siman the instance created
     */
    public static EmbeddedSiman CreateStop(){
        return new EmbeddedSiman(SimanTypeEnum.STOP);
    }
     ...
     * @return Siman the instance created
     */
    public static EmbeddedSiman CreateLoad(Map<String, Serializable> loadArgs){
        EmbeddedSiman loadSiman = new EmbeddedSiman(SimanTypeEnum.LOAD);
     ...
     *
     * @return Map<String, generated.course.InteropInputs>
     */
