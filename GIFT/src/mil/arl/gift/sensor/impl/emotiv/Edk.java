/**
 * This is third party code downloaded from emotiv website:
 * http://www.emotiv.com/bitrix/components/bitrix/forum.interface/show_file.php?fid=1351&action=download
 */
    ...
    //DEPLOYMENT::NON_PREMIUM_RELEASE::REMOVE_END
    	...
    	public static class InputSensorDescriptor_t extends Structure {
            ...
            protected List<String> getFieldOrder() {
    	        return Arrays.asList("channelId", "fExists", "pszLabel",
    	                "xLoc", "yLoc", "zLoc");
    	    }
    	}
