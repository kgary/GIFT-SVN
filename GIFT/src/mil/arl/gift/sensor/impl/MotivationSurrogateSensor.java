 ...
 *
 */
public class MotivationSurrogateSensor extends AbstractSensor{

    /** instance of the logger */
    private static Logger logger = LoggerFactory.getLogger(MotivationSurrogateSensor.class);
    
    private static final SensorAttributeNameEnum ATTRIBUTE = SensorAttributeNameEnum.MOTIVATION;
    private static final SensorTypeEnum SENSOR_TYPE = SensorTypeEnum.MOTIVATION_SURROGATE;
    ...
    static{
        ...
        EventProducerAttribute attribute = new EventProducerAttribute(ATTRIBUTE, DoubleValue.class);
        eventProducerInformation.addAttribute(attribute);
    }
     ...
     */
    public MotivationSurrogateSensor(String sensorName){
