...
/**
 * This interface is used by scenarios to notify domain knowledge when scenario actions or events have happened.
 * 
 * @author mhoffman
 *
 */
public interface ScenarioActionInterface {
    
    /**
     * Notification that a scenario has started
     */
    public void scenarioStarted();

    /**
     * Notification that a scenario ended
    ...
    /**
     * Notification that the scenario had a fatal error and it needs to be handled.
     * 
