...
/**
 * This is the interface for performance assessment nodes that can handle condition lesson assessments.
 * 
 * @author mhoffman
 *
 */
public interface ConditionLessonAssessmentHandlerInterface {
