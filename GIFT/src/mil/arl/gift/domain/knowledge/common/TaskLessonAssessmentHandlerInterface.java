...
/**
 * This is the interface for performance assessment nodes that can handle task lesson assessments.
 * 
 * @author mhoffman
 *
 */
public interface TaskLessonAssessmentHandlerInterface {

    /**
     * This method is used to inform the parent performance assessment node would like additional assessing (if available) 
     * and that the task should execute further or different assessments in regards to the 
     * knowledge/interface it has at it's disposal.  For instance, a task may want to perform additional assessment
