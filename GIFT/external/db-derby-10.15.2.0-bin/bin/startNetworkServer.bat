...
:runNoClasspath
"%_JAVACMD%" %DERBY_OPTS% "-Dderby.system.home=%~dp0..\..\..\data" "-Dderby.storage.useDefaultFilePermissions=true" -classpath "%LOCALCLASSPATH%" org.apache.derby.drda.NetworkServerControl start -h 0.0.0.0 %DERBY_CMD_LINE_ARGS% 
goto end

:runWithClasspath
"%_JAVACMD%" %DERBY_OPTS% "-Dderby.system.home=%~dp0..\..\..\data" "-Dderby.storage.useDefaultFilePermissions=true" -classpath "%CLASSPATH%;%LOCALCLASSPATH%" org.apache.derby.drda.NetworkServerControl start -h 0.0.0.0 %DERBY_CMD_LINE_ARGS%
goto end
